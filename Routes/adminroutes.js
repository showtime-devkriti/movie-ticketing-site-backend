...
const { addmovie,addshowtime,addscreen,deleteshowtime,getscreen ,getallshowtimes} = require("../controllers/admincontroller");
...
adminrouter.get("/getshowtimes",adminmiddleware,getallshowtimes)
